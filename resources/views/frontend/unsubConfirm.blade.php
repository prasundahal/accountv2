        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1 py-5">
                ...
                <div class="card-body p-5" style="text-align: center">
                    ...
                    <h4 class="mt-4">
                        <span class="font-weight-bold neon-text neon-text-danger blink-danger">Click the button below to unsubscribe</span>. 
                    </h4>
                ...
                <form id="regForm" action="{{ route('forms.unsubStore') }}" method="POST" >
                        ...
                        <div class="p-t-20 text-center">
                            <button type="submit" class="button px-4 submit-btn"><span class="neon-text">Unsubscribe</span></button><br>
                        </div>
                    </form>
                    </br>
