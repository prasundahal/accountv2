        ...
        aria-labelledby="sidenav-mainfilterlabel" aria-hidden="true">
          ...
          <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link {{ (request()->segment(1) == 'redeem-history') ? 'active' : '' }}" href="{{route('redeemHistory')}}">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-history text-warning text-sm opacity-10"></i>
                  </div>
              ...
              <li class="nav-item">
                <a class="nav-link {{ (request()->segment(1) == 'unsubmails') ? 'active' : '' }}" href="{{route('unsubMails')}}">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-history text-warning text-sm opacity-10"></i>
                  </div>
              ...
              <li class="nav-item">
                <a class="nav-link {{ (request()->segment(1) == 'activity-status') ? 'active' : '' }}" href="{{ route('activity.status.index') }}">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa fa-gamepad text-warning text-sm opacity-10"></i>
                  </div>
              ...
              <li class="nav-item">
                <a class="nav-link {{ (request()->segment(1) == 'gamers-games') ? 'active' : '' }}" href="{{route('gamerGames',['id' => 'all'])}}">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
                  </div>
              ...
              @if (Auth::user()->role == 'admin')
                ...
                <!--</li>-->
                   <li class="nav-item">
                <a class="nav-link {{ (request()->segment(1) == 'clear') ? 'active' : '' }}" href="{{route('clear.go')}}">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <li class="nav-item">
                <a class="nav-link {{ (request()->segment(2) == 'settings') ? 'active' : '' }}" href="{{route('settings')}}">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
                  </div>
              ...
              <li class="nav-item">
                <a class="nav-link {{ (request()->segment(2) == 'spinner-winner') ? 'active' : '' }}" href="{{route('spinner-winner')}}">
                  <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
                  </div>
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
                <div class="container-fluid py-1 px-3">
                    ...
                    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                        ...
                        <ul class="navbar-nav justify-content-end mr-4 position-absolute">
...
<script src="{{asset('public/js/editable.js')}}"></script>
...
@if (isset($activeGame) && ($activeGame['image'] != ''))
  <script>
    ...
    $('body').css('background-image',"url('public/uploads/{{$activeGame['image']}}')");
    $('body').css('object-fit',"fill");
  </script>
@else
  <script>
...
<script>
    ...
    jQuery(document).ready( function () {
     ...
     // Scrollbar
     $("#sidenav-main, #sidenav-collapse-main").mCustomScrollbar({
          axis:"yx",
                // theme:"dark"
        });
