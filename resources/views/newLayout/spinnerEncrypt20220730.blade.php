...
<html lang="en">
   ...
   <body>
    @php
        $winner = (isset($final) && !empty($final['winner_info']))?$final['winner_info']['player_name']:'';
        $winner = 'Winner of '.date('Y').' '.date('M').' is '.$winner;
    @endphp
    <script>
                  ...
                  <div id="image-carousel" class="carousel slide" data-ride="carousel" style="margin-left:85px">
                     <div class="player-list neon-text" style="height:100vh !important;font-family:cursive;background:rgba(0,0,0,0.6) ">
                        <div style="width:22vw;">
                           <strong>
                              <h3 style="margin-left:25px;margin-top: 15px;">
                                 <b>
               ...
               <div class="text-center mt-4" style="height:100vh">
                  <div id="image-carousel" class="carousel slide" data-ride="carousel">
                     <div class="player-list2 neon-text" style="height:-webkit-fill-available;background:rgba(0,0,0,0.6) !important;font-family:cursive;left:0px !important; width:30vw ">
                        <div style="width:22vw">
                           <strong>
                              <h3 style="margin-left:25px;margin-top: 15px;"><b><span class="neon-text font-weight-bold">Past Winners</span></b></h3>
                           </strong>
                           <ul>
                              @if (!empty($old_list))
      ...
      <script>
         ...
         let audio = new Audio('{{ URL::to('/assets/tick.mp3') }}');  // Create audio object and load desired file.
         ...
         function winAnimation() {
             ...
             document.getElementById("welcome_container").innerHTML='<p class="winner-para">'+winnerName+'</p>';
